  ...
  return (
    ...
    >
      <div className={clsx(
        ...
        isActive ? 'bg-white rounded-t-xl' : 'bg-indigo-50',
      )}
      >
...
export function SecondaryFeaturesCRM() {
  return (
    <section
      id="crm"
      aria-label="Features for simplifying everyday business tasks"
      className="py-12 bg-indigo-50"
    >
      <Container>
        <div className="mx-auto max-w-xl md:text-center">
          <h2 className="text-base font-bold leading-7 text-indigo-700">CRM</h2>
          <h3 className="font-display font-semibold text-4xl tracking-tight text-indigo-800 sm:text-6xl">
            Simplify everyday business tasks.
          </h3>
