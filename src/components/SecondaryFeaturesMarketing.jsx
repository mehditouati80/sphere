  ...
  return (
    ...
    >
      <div className={clsx(
        ...
        isActive ? 'bg-white rounded-t-xl' : 'bg-pink-50',
      )}
      >
        ...
        <div
          className={clsx(
            ...
            isActive ? 'bg-pink-600' : 'bg-pink-600',
          )}
        >
                          ...
                          {infos.map((info) => (
                            <div key={info.name} className="relative pl-9">
                              <dt className="inline font-semibold text-slate-500">
                                <info.icon className="absolute left-1 top-1 h-5 w-5 text-pink-600" aria-hidden="true" />
                                {info.name}
                              </dt>{' '}
...
export function SecondaryFeaturesMarketing() {
  return (
    <section
      id="marketing"
    ...
    >
      <Container>
        <div className="mx-auto max-w-xl md:text-center">
          <h2 className="text-base font-bold leading-7 text-pink-400">Marketing</h2>
          <h3 className="font-display font-semibold text-4xl tracking-tight text-pink-600 sm:text-6xl">
            Simplify everyday business tasks.
          </h3>
