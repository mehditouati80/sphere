  ...
  return (
    ...
    >
      <div className={clsx(
        ...
        isActive ? 'bg-white rounded-t-xl' : 'bg-orange-50',
      )}
      >
        ...
        <div
          className={clsx(
            ...
            isActive ? 'bg-orange-600' : 'bg-orange-600',
          )}
        >
  ...
  return (
    ...
    <>
      ...
      <TabGroup className="hidden mt-6  lg:block">
        {({ selectedIndex }) => (
          <>
            <TabList className="grid grid-cols-6 items-center sticky top-0 z-10">
                          ...
                          {infos.map((info) => (
                            <div key={info.name} className="relative pl-9">
                              <dt className="inline font-semibold text-slate-500">
                                <info.icon className="absolute left-1 top-1 h-5 w-5 text-orange-600" aria-hidden="true" />
                                {info.name}
                              </dt>{' '}
...
export function SecondaryFeaturesBrave() {
  return (
    <section
      id="cruise"
    ...
    >
      <Container>
        <div className="mx-auto max-w-xl md:text-center">
          <h2 className="text-base font-bold leading-7 text-orange-400">Brave Booking</h2>
          <h3 className="font-display font-semibold text-4xl tracking-tight text-orange-600 sm:text-6xl">
            Simplify everyday business tasks.
          </h3>
